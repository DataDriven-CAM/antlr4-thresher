...
$(libprefix)antlr4thresher.$(ext): CXXFLAGS= -DNDEBUG -g -pthread -std=c++26  -Iinclude -MMD 
...
cantlrtool: CXXFLAGS= -DNDEBUG -g -fPIC -pthread -std=c++26  -Iinclude -MMD 
...
build/src/parse/G4Reader.o: CXXFLAGS= -DNDEBUG -g -fPIC -pthread -std=c++26 -I./include -I$(MODULE_DIRECTORY)/fmt/dist/include -I$(MODULE_DIRECTORY)/graph-v2/include -I$(MODULE_DIRECTORY)/mio/include -MMD -MP
build/src/parse/G4Reader.o: ./src/parse/G4Reader.cpp 
	@mkdir -p $(@D)
	$(CXX) $(CXXFLAGS) -c -o build/src/parse/G4Reader.o ./src/parse/G4Reader.cpp

build/src/dsl/Morpher.o: CXXFLAGS= -DNDEBUG -g -fPIC -pthread -std=c++26 -I./include -I$(MODULE_DIRECTORY)/fmt/dist/include -I$(MODULE_DIRECTORY)/graph-v2/include -I$(MODULE_DIRECTORY)/mio/include -MMD -MP
build/src/dsl/Morpher.o: ./src/dsl/Morpher.cpp 
	pwd
	@mkdir -p $(@D)
	$(CXX) $(CXXFLAGS) -c -o build/src/dsl/Morpher.o ./src/dsl/Morpher.cpp

#build/src/publishing/CodeGenerator.o: CXXFLAGS= -DNDEBUG -g -pthread -std=c++26 -I../include -I$(MODULE_DIRECTORY)/fmt/dist/include -I$(MODULE_DIRECTORY)/graph-v2/include -I$(MODULE_DIRECTORY)/mio/include -MMD -MP
...
build/tool/src/main.o : CXXFLAGS=-std=c++26 -DNDEBUG -g -fPIC -fpermissive -I./include -I$(MODULE_DIRECTORY)/CLI11/include -I$(MODULE_DIRECTORY)/fmt/dist/include -I$(MODULE_DIRECTORY)/graph-v2/include -MMD
